...
TValue_t __main() {
  ...
  // Fields for table __subtable_literals_top
  ...
  // Fields for table __subtable_literals_bottom
  ...
  // Fields for table __subtable_literals_left
  ...
  // Fields for table __subtable_literals_right
