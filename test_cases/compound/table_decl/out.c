...
TValue_t __main() {
  ...
  __subtable_idk_good_name_prefix_top = TTAB(make_table(4));
  ...
  __subtable_idk_good_name_prefix_bottom = TTAB(make_table(4));
  ...
  __subtable_idk_good_name_prefix_left = TTAB(make_table(4));
  ...
  __subtable_idk_good_name_prefix_right = TTAB(make_table(4));
